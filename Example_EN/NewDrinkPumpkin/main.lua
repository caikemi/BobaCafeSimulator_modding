...
local M = {
    id          = "NewDrinkPumpkin",
    name        = "Add Pumpkin Juice Recipe",
    description = "Adds a Pumpkin Juice recipe",
    version     = "1.0.0",
    author      = "yiming",
...
local function add_new_drink()
    ...
    D.ID = 5201  -- Recommended range: 5200-5999
    -- Name
    D.DisplayName = "Pumpkin Juice"
    ...
    -- Image path
    D.ImagePath = dir .. "5201.png" -- An image in your Mod directory
    ...
    D.DrinkWaterFName = "Drink.PumpkinJuice"  -- New liquid type
    -- Required recipe items, for example four orange slices
    ...
    D.MakeNeedTutorialText = "Make pumpkin juice"
    ...
    -- ------------------------------------------------------------
    -- 5) Drink color (Pumpkin Juice already has a color in the game)
    -- ------------------------------------------------------------
