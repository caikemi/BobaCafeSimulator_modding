...
local items = {
    {
        ...
        name = "Dog Decoration",
        description = "A dog-themed furniture piece from the animal decoration pack.",
        mesh = "SM_ToyDog_01",
    ...
    },
    {
        ...
        description = "An elephant-themed furniture piece from the animal decoration pack.",
    ...
    },
    {
        ...
        name = "Rocking Horse Decoration I",
        description = "The first rocking-horse furniture piece in the pack.",
        mesh = "SM_ToyHorse_01",
    ...
    },
    {
        ...
        name = "Rocking Horse Decoration II",
        description = "The second rocking-horse furniture piece in the pack.",
        mesh = "SM_ToyHorse_02",
