...
| 0 | — | 香蕉汁 | `R=1 G=0.871 B=0 A=1` | `R=1 G=0.792 B=0 A=1` |
| 0 | — | 草莓汁 | `R=1 G=0.168 B=0.258 A=1` | `R=1 G=0.161 B=0.193 A=1` |
...
| 0 | — | 热水 | `R=0.382 G=0.965 B=1 A=1` | `R=0.622 G=0.866 B=0.96 A=1` |
| 0 | `Drink.PureWater` | 纯净水 | `R=0.311 G=0.848 B=1 A=1` | `R=0.624 G=0.863 B=0.956 A=1` |
| 0 | — | 生鱼片绿茶 | `R=0.553 G=0.564 B=0.128 A=1` | `R=0.408 G=0.46 B=0.11 A=1` |
